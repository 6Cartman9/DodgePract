...
public class RaceResultTime : MonoBehaviour, IDependency<RaceTimeTracker>, IDependency<RaceStateTracker>
{
    ...
    public float CurrentTime => curretTime;
    ...
    private void OnRaceCompleted()
    {
        ...
        if(raceTimeTracker.CurretTime < absoluteRecord || playerRecordTime == 0)
        {
            playerRecordTime = raceTimeTracker.CurretTime;

            Save();
        }

        curretTime = raceTimeTracker.CurretTime;
